...
#This is a copy of the original PairClassifier.py in ExplainablePairwiseClassifer
#This copy classifies without any use of alternative outputs.
#All pairwise classifications result in a 1 or -1




#Classifies one instance in the dataframe in row indicated by index
#method denots which configuration to use.
#1 = class voting, 2 = victim elimination, 3 = tourney, 4 = hybrid
...
#Reducing the number of features present to only the ones being used to speed up processing
...
#acc refers to accuracy, while multi refers to the number of multiclass outputs
